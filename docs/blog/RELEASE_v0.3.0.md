...
We are thrilled to announce the release of **Core CMS v0.3.0**. This update represents a major leap forward in usability, customization, and security. While v0.2.0 laid the foundation for content creation, v0.3.0 turns the system into a fully managed platform ready for diverse teams and designs.
...
[**View the Changelog**](https://github.com/BrainAV/core-cms/releases/tag/v0.3.0) | [**Download v0.3.0**](https://github.com/BrainAV/core-cms/archive/refs/tags/v0.3.0.zip)
